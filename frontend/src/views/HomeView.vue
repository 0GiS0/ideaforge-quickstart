...
<template>
  ...
  <div v-if="true" class="flex min-h-[calc(100vh-73px)] flex-col items-center justify-center text-center">
    <!-- Coffee cup -->
    <div class="mb-8">
    ...
    <div v-else class="mt-8 inline-flex items-center gap-2 rounded-full bg-amber-50 px-4 py-2 text-sm text-amber-700">
